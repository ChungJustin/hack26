  ...
  return (
    <div className="min-h-screen bg-background-warm text-text-main">
      ...
      <main className="mx-auto w-full max-w-6xl px-5 pb-20">
        ...
        <section className="rounded-3xl border border-orange-200 bg-white p-6 shadow-sm md:p-8">
          ...
          <button
            type="button"
            className="mt-5 rounded-full bg-orange-950 px-6 py-3 font-bold text-white transition hover:bg-primary"
          >
            다음 단계로
          </button>
        </section>
